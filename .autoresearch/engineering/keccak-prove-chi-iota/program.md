# autoresearch — keccak-prove-chi-iota
...
- Additional constraints: Optimize proving throughput only. Preserve proof correctness and public API. Do not modify the evaluation harness after setup.
